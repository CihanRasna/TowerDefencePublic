namespace Vanta.UI.TableView
{
	...
	/// </summary>
	public interface ITableViewReachable
	{
		/// <summary>
		...
		/// </summary>
		void TableViewReachedTopmostOrRightmost(TableView tableView);
		/// <summary>
		/// Will be fired once if the table view has reached the bottommost pr leftmost.
		/// Will not be fired when the table view is bouncing back.
		/// </summary>
		void TableViewReachedBottommostOrLeftmost(TableView tableView);
		/// <summary>
		...
		/// </summary>
		void TableViewLeftTopmostOrRightmost(TableView tableView);
		/// <summary>
		/// Will be fired once if the table view has left the bottommost or leftmost.
		/// Will not be fired when the table view is stretching.
		/// </summary>
		void TableViewLeftBottommostOrLeftmost(TableView tableView);
		/// <summary>
		...
		/// </summary>
		float TableViewReachableEdgeTolerance(TableView tableView);
	}
}
